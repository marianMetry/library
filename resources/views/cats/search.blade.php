...
@section('main')
    <h1 style="font-weight: bold" class="text-center p-5">Search categories for {{$keyword}}</h1>
    ...
    <form  method="get" action="{{ route('search')}}">
        <div class="mb-3 d-flex justify-content-center align-items-end">
            <input type="text" name="keyword" value="{{$keyword}}" placeholder="search" class="form-control" id="exampleInputName" >
